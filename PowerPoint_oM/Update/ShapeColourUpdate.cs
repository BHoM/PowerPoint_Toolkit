...
{
    [Description("Allows to update the colour of a shape")]
    public class ShapeColourUpdate : BHoMObject, ISlideUpdate
    {
        ...
        [Description("New fill hex colour represenation of the element.")]
